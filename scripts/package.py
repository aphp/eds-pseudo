...
# - export a package (for pseudonymisation rules) as well as the model weights
# - keep the same requirements as those listed in the pyproject.toml file
# - include package_data for the pseudonymisation rules, listed also in the pyproject
